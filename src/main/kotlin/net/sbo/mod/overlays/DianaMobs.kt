    ...
    fun updateLines(screen: String = "") {
        ...
        lines.addAll(
            listOf(
                ...
                createLine("SPHINX","$GRAY - ${DARK_PURPLE}Sphinx: $AQUA${Helper.formatNumber(tracker.mobs.SPHINX, true)} $GRAY($AQUA${sphinxPercent}%$GRAY)" + " [${AQUA}LS$GRAY:$AQUA${Helper.formatNumber(tracker.mobs.SPHINX_LS, true)}$GRAY]", tracker.mobs.SPHINX + tracker.mobs.SPHINX_LS),
